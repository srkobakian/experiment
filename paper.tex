...
Stephanie Kobakian %% -- end for/affiliation.institution.author
}
\IEEEauthorblockA{Science and Engineering Faculty\\
...
\IEEEauthorblockN{
  %% -- beg for/affiliation.institution.author
Dianne Cook %% -- end for/affiliation.institution.author
}
\IEEEauthorblockA{Econometrics and Business Statistics Faculty\\
Monash University\\
Melbourne, Australia
\\dicook@monash.edu
}
