...
The R package \texttt{gstat} {[}\protect\hyperlink{ref-gstat}{14}{]} was used to simulate 144 null sets, 12 data sets for each plot in a lineup, and 12 sets for 12 lineups.
...
The data collection took place using a secure link between the survey web application and the googlesheet used to store results. The application would first connect to the googlesheet using the googlesheets {[}\protect\hyperlink{ref-sheets}{15}{]} R package, and interacted again at the completion of the survey by adding the participant's responses to the 12 displays as 12 rows of data in the googlesheet.

\hypertarget{participants}{%
\subsection{Participants}\label{participants}}

Participants were recruited for to evaluate lineups from the Figure Eight crowd sourcing platform {[}\protect\hyperlink{ref-figeight}{16}{]}.
...
The R {[}\protect\hyperlink{ref-RCore}{17}{]} \texttt{glmer()} function in the {[}\protect\hyperlink{ref-lme4}{18}{]} package implements generalised linear mixed effect models. The model used includes the two main effects map type and trend model, which gives the fixed effects model to be:
...
Computation will be done using R {[}\protect\hyperlink{ref-RCore}{17}{]}, with the \texttt{lme4} package {[}\protect\hyperlink{ref-lme4}{18}{]}.
...
The authors would like to thank the Australian Cancer Atlas team for discussions regarding alternative spatial visualizations, and Professor Kerrie Mengersen and Dr Earl Duncan for regular meetings filled with suggestions and comments. Mitchell O'Hara-Wild was a co-developer of the taipan {[}\protect\hyperlink{ref-taipan}{19}{]} R package for image tagging, used as the base for the web app constructed to collect participant evaluations of lineups. We are thankful for the NUMBATs (Non-Uniform Monash Business Analytics Team) for participating in the pilot study that helped to assess the experimental design and determine an appropriate sample size for the study.
...
The analysis of the work was completed in R {[}\protect\hyperlink{ref-RCore}{17}{]} with the use of the following packages:

\begin{itemize}
\tightlist
\item
  For document creation: rmarkdown {[}\protect\hyperlink{ref-rmarkdown}{20}{]}, rticles {[}\protect\hyperlink{ref-rticles}{21}{]}, knitr {[}\protect\hyperlink{ref-knitr}{22}{]}.
\item
  For lineup creation and data analysis: tidyverse {[}\protect\hyperlink{ref-tidyverse}{23}{]}, nullabor {[}\protect\hyperlink{ref-nullabor}{24}{]}, ggthemes {[}\protect\hyperlink{ref-ggthemes}{25}{]}, RColorBrewer {[}\protect\hyperlink{ref-RColorBrewer}{26}{]}.
\item
  For image displays: cowplot {[}\protect\hyperlink{ref-cowplot}{27}{]}, png {[}\protect\hyperlink{ref-png}{28}{]}, grid {[}\protect\hyperlink{ref-grid}{29}{]}.
\item
  For modelling and presentation of models: gstat {[}\protect\hyperlink{ref-gstat}{14}{]}, lme4 {[}\protect\hyperlink{ref-lme4}{18}{]}, kableExtra {[}\protect\hyperlink{ref-kableExtra}{30}{]}.
\end{itemize}
...
14. Gräler B, Pebesma E, Heuvelink G (2016) Spatio-temporal interpolation using gstat. The R Journal 8:204--218

\leavevmode\hypertarget{ref-sheets}{}%
15. Bryan J, Zhao J (2018) Googlesheets: Manage google spreadsheets from r.

\leavevmode\hypertarget{ref-figeight}{}%
16. (2019) The essential high-quality data annotation platform. Figure Eight
...
19. Kobakian S, O'Hara-Wild M (2018) Taipan: Tool for annotating images in preparation for analysis.

\leavevmode\hypertarget{ref-rmarkdown}{}%
20. Xie Y, Allaire JJ, Grolemund G (2018) R markdown: The definitive guide. Chapman; Hall/CRC, Boca Raton, Florida

\leavevmode\hypertarget{ref-rticles}{}%
21. Allaire J, Xie Y, R Foundation, et al (2019) Rticles: Article formats for r markdown.

\leavevmode\hypertarget{ref-knitr}{}%
22. Xie Y (2014) Knitr: A comprehensive tool for reproducible research in R. Implementing reproducible computational research

\leavevmode\hypertarget{ref-tidyverse}{}%
23. Wickham H, Averick M, Bryan J, et al (2019) Welcome to the tidyverse. Journal of Open Source Software 4:1686

\leavevmode\hypertarget{ref-nullabor}{}%
24. Wickham H, Chowdhury NR, Cook D, Hofmann H (2018) Nullabor: Tools for graphical inference.

\leavevmode\hypertarget{ref-ggthemes}{}%
25. Arnold JB (2019) Ggthemes: Extra themes, scales and geoms for 'ggplot2'.

\leavevmode\hypertarget{ref-RColorBrewer}{}%
26. Neuwirth E (2014) RColorBrewer: ColorBrewer palettes.

\leavevmode\hypertarget{ref-cowplot}{}%
27. Wilke CO (2019) Cowplot: Streamlined plot theme and plot annotations for 'ggplot2'.

\leavevmode\hypertarget{ref-png}{}%
28. Urbanek S (2013) Png: Read and write png images.
...
30. Zhu H (2019) KableExtra: Construct complex table with 'kable' and pipe syntax.
