...
The choropleth map was used as the comparative visualization for presenting the lineups {[}\protect\hyperlink{ref-VVSIALM}{15}{]} as this is the common display for spatial cancer data.
...
The data analysis methods used in order to analyse and collate the results included downloading the survey submissions and opening them into the analysis software R {[}\protect\hyperlink{ref-RCore}{16}{]}.
...
The R {[}\protect\hyperlink{ref-RCore}{16}{]} \texttt{glmer()} function in the {[}\protect\hyperlink{ref-lme4}{17}{]} package implements generalised linear mixed effect models. The model used includes the two main effects map type and trend model, which gives the fixed effects model to be:
...
Computation will be done using R {[}\protect\hyperlink{ref-RCore}{16}{]}, with the \texttt{lme4} package {[}\protect\hyperlink{ref-lme4}{17}{]}.
...
The analysis of the work was completed in R {[}\protect\hyperlink{ref-RCore}{16}{]} with the use of the following packages:

\begin{itemize}
\tightlist
\item
  For document creation: rmarkdown {[}\protect\hyperlink{ref-rmarkdown}{18}{]}, rticles {[}\protect\hyperlink{ref-rticles}{19}{]}, knitr {[}\protect\hyperlink{ref-knitr}{20}{]}.
\item
  For lineup creation and data analysis: tidyverse {[}\protect\hyperlink{ref-tidyverse}{21}{]}, nullabor {[}\protect\hyperlink{ref-nullabor}{22}{]}, ggthemes {[}\protect\hyperlink{ref-ggthemes}{23}{]}, RColorBrewer {[}\protect\hyperlink{ref-RColorBrewer}{24}{]}.
\item
  For image displays: cowplot {[}\protect\hyperlink{ref-cowplot}{25}{]}, png {[}\protect\hyperlink{ref-png}{26}{]}, grid {[}\protect\hyperlink{ref-grid}{27}{]}.
\item
  For modeling and presentation of models: lme4 {[}\protect\hyperlink{ref-lme4}{17}{]}, kableExtra {[}\protect\hyperlink{ref-kableExtra}{28}{]}.
\end{itemize}
...
15. Majumder M, Hofmann H, Cook D (2013) Validation of visual statistical inference, applied to linear models. Journal of the American Statistical Association 108:942--956
...
17. Bates D, Mächler M, Bolker B, Walker S (2015) Fitting linear mixed-effects models using lme4. Journal of Statistical Software 67:1--48

\leavevmode\hypertarget{ref-rmarkdown}{}%
18. Xie Y, Allaire JJ, Grolemund G (2018) R markdown: The definitive guide. Chapman; Hall/CRC, Boca Raton, Florida

\leavevmode\hypertarget{ref-rticles}{}%
19. Allaire J, Xie Y, R Foundation, et al (2019) Rticles: Article formats for r markdown.

\leavevmode\hypertarget{ref-knitr}{}%
20. Xie Y (2014) Knitr: A comprehensive tool for reproducible research in R. Implementing reproducible computational research

\leavevmode\hypertarget{ref-tidyverse}{}%
21. Wickham H, Averick M, Bryan J, et al (2019) Welcome to the tidyverse. Journal of Open Source Software 4:1686

\leavevmode\hypertarget{ref-nullabor}{}%
22. Wickham H, Chowdhury NR, Cook D, Hofmann H (2018) Nullabor: Tools for graphical inference.

\leavevmode\hypertarget{ref-ggthemes}{}%
23. Arnold JB (2019) Ggthemes: Extra themes, scales and geoms for 'ggplot2'.

\leavevmode\hypertarget{ref-RColorBrewer}{}%
24. Neuwirth E (2014) RColorBrewer: ColorBrewer palettes.

\leavevmode\hypertarget{ref-cowplot}{}%
25. Wilke CO (2019) Cowplot: Streamlined plot theme and plot annotations for 'ggplot2'.

\leavevmode\hypertarget{ref-png}{}%
26. Urbanek S (2013) Png: Read and write png images.
...
28. Zhu H (2019) KableExtra: Construct complex table with 'kable' and pipe syntax.
