...
chance of reptition using resampling was introduced to prevent
...
The differences seen in the \ref{fig:detect-compare} plot and Table.
\ref{tab:desc-stats} are reflected in the model results. Surprisingly
the difference for the geographic distribution was significant at the
...
\bibitem[\citeproctext]{ref-sugarbag}
\CSLLeftMargin{1. }%
...
\bibitem[\citeproctext]{ref-atlas}
\CSLLeftMargin{2. }%
...
\bibitem[\citeproctext]{ref-CBATCC}
\CSLLeftMargin{6. }%
...
\bibitem[\citeproctext]{ref-ACTUC}
\CSLLeftMargin{7. }%
...
\bibitem[\citeproctext]{ref-CDWCS}
\CSLLeftMargin{10. }%
...
\bibitem[\citeproctext]{ref-review}
\CSLLeftMargin{11. }%
...
\bibitem[\citeproctext]{ref-BCHLLSW09}
\CSLLeftMargin{12. }%
...
\bibitem[\citeproctext]{ref-GTPCCD}
\CSLLeftMargin{13. }%
...
\bibitem[\citeproctext]{ref-abs2016}
\CSLLeftMargin{15. }%
...
\bibitem[\citeproctext]{ref-gstat}
\CSLLeftMargin{17. }%
...
\bibitem[\citeproctext]{ref-taipan}
\CSLLeftMargin{20. }%
...
\bibitem[\citeproctext]{ref-sheets}
\CSLLeftMargin{21. }%
...
\bibitem[\citeproctext]{ref-figeight}
\CSLLeftMargin{22. }%
...
\bibitem[\citeproctext]{ref-nullabor}
\CSLLeftMargin{27. }%
...
\bibitem[\citeproctext]{ref-RColorBrewer}
\CSLLeftMargin{29. }%
