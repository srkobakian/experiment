...
```{r cities-geo4, results = "asis", fig.cap = "The lineup of choropleth map displays hides a distribution that affects all capital cities."}
ggdraw() +
...
```{r cities-geo3, results = "asis", fig.cap = "The lineup of choropleth map displays hides a distribution that affects all capital cities."}
ggdraw() +
