...
set. Place in the lineup is recorded as `Location'.}
...
data plot (1) or did not (0), \(\mu_\) is the subject-specific random
intercept, \(\tau_j\) is the map type effect, \(\delta_k\) is the trend
model effect. The interaction between map type and trend model allows
for any map type effect to differ between trend models. As each
