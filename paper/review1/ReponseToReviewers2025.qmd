...
Add introductory thank you to reviewers for their work, and the editor for their consideration.

## To Do

Make a release version on github of current copy before changes

all points made be reviewers, must be addressed with a response using different font types for review comment v our response

In our Rmd file use XXX for difficult change to make - allocated to Di or Steph 

# Review of “Comparing the Effectiveness of the Choropleth Map with a Hexagon Tile Map  for Communicating Cancer Statistics” 

Associate Editor

Dear associate editor XXX,

Thank you for the opportunity to improve this paper with the suggestions made in the comments provided. Please find our responses to the comments provided in *italics* below each paragraph or comment.
...
*The location has now been mentioned in the caption, and a reference has been added in the text to direct readers to the alternative view.*
...
P16, L247. What is a “Figure Eight contributor ID”? : *This was used by the respondent to uniquely identify themselves and allow us to link them to the paid account we used for recruitment and payment. This reference has been removed, and in other places has been replaced with a unique identifier created for each participant.*
