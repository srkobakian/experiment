...
This document was written using quarto. This document contains the code to produce the summaries, plots and additional checks in the paper. All the code to reproduce the analysis, and do additional checks can be found at [https://github.com/srkobakian/experiment](https://github.com/srkobakian/experiment).
