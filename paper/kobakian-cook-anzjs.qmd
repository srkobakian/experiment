...
```{r}
#| label: tbl-reason
#| tbl-cap: "Summary of the reasons that participants wrote for their choice of plot when looking at each trend model shown in choropleth and hexagon tile maps."
...
- Other plot/map type comparisons, insets, cartograms, statistical plots along with maps, especially interactive
