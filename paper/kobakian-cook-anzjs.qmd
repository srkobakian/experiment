...
When a choropleth map display is used, the predicted detection rate for the Three Cities trend, `r round(exp(0.07-3.41)/(1+exp(0.07-3.41)),2)` is extremely low, especially compared to the NW-SE trend of `r round(exp(0.07)/(1+exp(0.07)),2)`.
...
```{r}
#| label: tbl-reason
#| tbl-cap: "The main reason that participants wrote for their choice of plot when looking at each trend model shown in choropleth and hexagon tile maps."
