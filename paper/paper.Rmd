...
The experiment was conducted using the lineup protocol, a visual inference procedure (XXX ref), to objectively test the effectiveness of the two displays. 

The paper is organised as follows. The next section discusses the background of georgraphic data display ane visual inference procedures. Section XXX describes the methods for conducting the experiment and analysing the results. The results are summarized in Section XXX. 
...
```{r training1, results = "asis", fig.cap = "The training lineups of choropleth maps.", fig.width = 4, fig.height = 4}
ggdraw() +
  draw_plot(rasterGrob(readPNG("figures/fig8_training1.png")))
```


```{r training2, results = "asis", fig.cap = "The training lineups of hexagon tile maps.", fig.width = 4, fig.height = 4}
ggdraw() +
...
The demonstrative images of the `shinydashboard` web application display the demographic and consent page in Fig. \ref{fig:survey-demogs}.


```{r survey-demogs, results = "asis", fig.cap = "The demographics questions tab of the shinydashboard survey application.", fig.width = 4, fig.height = 4}
ggdraw() +
...
```{r survey-hex, results = "asis", fig.cap = "An example of the hexagon tile map lineup shown in the survey tab of the shinydashboard app.", fig.width = 4, fig.height = 4}
ggdraw() +
...
```{r survey-choro, results = "asis", fig.cap = "An example of the choropleth map lineup shown in the survey tab of the shinydashboard app.", fig.width = 4, fig.height = 4}
ggdraw() +
...
```{r cities-geo, results = "asis", fig.cap = "The lineup of choropleth map displays hides a distribution that affects all capital cities.", fig.width = 4, fig.height = 4}
ggdraw() +
...
```{r cities-hex, results = "asis", fig.cap = "The lineup of choropleth map displays shows a distribution that affects all capital cities. The values for the inner city areas in the capital cities result in them being coloured red. However, the colour blue dominates the display as the large rural areas are filled. Replicate (2) for All Cities.", fig.width = 4, fig.height = 4}
ggdraw() +
...
```{r demogs, results = "asis", fig.cap = "The distribution of age groups of pariticpants."}
...
```{r gender, results = "asis", fig.cap = "The amount of participants who identify themselves by the pronouns He and She."}
dem_contribs %>% mutate(Gender = gender) %>% 
  count(Gender, name = "Amount") %>% knitr::kable(format = "latex", booktabs = TRUE)
```


```{r education, results = "asis", fig.cap = "The highest level of education acheived by the participants "}
dem_contribs %>%
  mutate(Education = factor(education, levels = c("High School", "Bach", "Masters"), labels = c("High School Diploma", "Bachelors Degree", "Masters Degree"))) %>% 
    count(Education, name =  "Amount") %>% knitr::kable(format = "latex", booktabs = TRUE)
```
