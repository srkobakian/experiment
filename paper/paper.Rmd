...
The All Cities trend model was created using the distance from the centroid of each geographic unit to the closest capital city in Australia. For each geographic unit, the distance to the closest capital city can be found when creating the hexagon tile map using the sugarbag [@sugarbag] package.
