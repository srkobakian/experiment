...
For document creation: rmarkdown, rticles, knitr.
For lineup creation and data analysis: tidyverse, nullabor, ggthemes, RcolorBrewer.
For image displays: cowplot, png, grid

For modeling and presentation of models: lme4, kableExtra
