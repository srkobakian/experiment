...
\hypersetup{
            pdftitle={Which is Better: a Choropleth Map or Hexagon Tile Map? A comparison using visual inference with crowdsourcing?},
...
using visual inference with crowdsourcing?}
